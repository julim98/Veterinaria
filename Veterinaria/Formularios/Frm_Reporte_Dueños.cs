...
{
    public partial class Frm_Reporte_Dueños: Form
    {
        public Frm_Reporte_Dueños()
        {
            InitializeComponent();
        }

        private void Frm_Reporte_Dueños_Load(object sender, EventArgs e)
        {
            ...
            this.datosdueñosBindingSource.DataSource = tabla;
